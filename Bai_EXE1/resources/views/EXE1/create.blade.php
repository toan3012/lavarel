                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.postUser') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <input type="phone" placeholder="Phone" id="phone" class="form-control" name="phone"
                                           required>
                                    @if ($errors->has('phone'))
                                ...
                                <div class="form-group mb-3">
                                    <input type="address" placeholder="Address" id="address" class="form-control" name="address"
                                           required>
